...
const TutorialPage = () => {
  ...
  useEffect(() => {
    const fetchDetails = async () => {
      ...
      setprevData({
        codetext: fetchData.data.code,
        inputArray: fetchData.data.inputArray,
        actionSteps: JSON.parse(fetchData.data.steps || "[]") as VisualizerAction[]
      })
  ...
  return (
    <>
      <ArrayAnimatorsDisplay topic={name} prevData={prevData} />
    </>
  )
}
